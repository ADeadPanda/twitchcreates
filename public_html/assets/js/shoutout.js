                        ...
                        getClips(getChannel, '20', function (info) {
                            ...
                            if (info.data[0]['created_at']) {
                                ...
                                // Text on top of clip
                                 ...
                                 let customText = getUrlParameter('customText').replace('{username}', ShoutChannel);



                                if (showText === 'true') {
                                    titleText = "<div id='text-container'><span class='title-text'>Go show " + info.data[0]['broadcaster_name'] + " some love!</span></div>"
                                }

                                if (customTextChk === 'true') {
                                    titleText = "<div id='text-container'><span class='title-text'>"+ customText +"</span></div>"
                                }
