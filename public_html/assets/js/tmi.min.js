                ...
                n.prototype.handleMessage = function(t) {
                    ...
                    if (!H.isNull(t)) {
                        ...
                        var e, s, o, i, r, a, c, u, l = H.channel(H.get(t.params[0], null)),
                            m = H.get(t.params[1], null),
                            h = H.get(t.tags["msg-id"], null),
                        ...
                        if (H.isNull(t.prefix)) switch (t.command) {
                            ...
                            default:
                                ...
                                case "376":
                                    ...
                                    this.channels = [];
                                    for (var b = 0; b < _.length; b++) ! function() {
                                        var e = _[b];
                                        g.add(function() {
                                            n._isConnected() && n.join(e).catch(function(e) {
                                ...
                                case "NOTICE":
                                    ...
                                    switch (h) {
                                        ...
                                        case "r9k_off":
                                            ...
                                            break;
                                        case "room_mods":
                                            var S = m.split(": ")[1].toLowerCase().split(", ").filter(function(e) {
                                                return e
                                            });
                                        ...
                                        case "no_mods":
                                            ...
                                            break;
                                        case "vips_success":
                                            var E = (m = m.endsWith(".") ? m.slice(0, -1) : m).split(": ")[1].toLowerCase().split(", ").filter(function(e) {
                                                return e
                                            });
                                        ...
                                        case "usage_clear":
                                            ...
                                            break;
                                        case "usage_mods":
                                            this.log.info(x), this.emits(["notice", "_promiseMods"], [y, [h, []]]);
                                            break;
                                        case "mod_success":
                                            this.log.info(x), this.emits(["notice", "_promiseMod"], k);
                                            break;
                                        case "usage_vips":
                                            this.log.info(x), this.emits(["notice", "_promiseVips"], [y, [h, []]]);
                                            break;
                                        case "usage_vip":
                                        ...
                                        case "bad_vip_achievement_incomplete":
                                            this.log.info(x), this.emits(["notice", "_promiseVip"], [y, [h, []]]);
                                            break;
                                        case "vip_success":
                                        ...
                                        case "bad_host_error":
                                        case "usage_host":
                                            this.log.info(x), this.emits(["notice", "_promiseHost"], [y, [h, null]]);
                                            break;
                                        case "already_r9k_on":
                                        case "usage_r9k_on":
                                        ...
                                        case "delete_message_success":
                                            this.log.info("[".concat(l, " ").concat(m, "]")), this.emits(["notice", "_promiseDeletemessage"], k);
                                        ...
                                        case "tos_ban":
                                        case "invalid_user":
                                            this.log.info(x), this.emits(["notice", "_promiseBan", "_promiseClear", "_promiseUnban", "_promiseTimeout", "_promiseDeletemessage", "_promiseMods", "_promiseMod", "_promiseUnmod", "_promiseVips", "_promiseVip", "_promiseUnvip", "_promiseCommercial", "_promiseHost", "_promiseUnhost", "_promiseJoin", "_promisePart", "_promiseR9kbeta", "_promiseR9kbetaoff", "_promiseSlow", "_promiseSlowoff", "_promiseFollowers", "_promiseFollowersoff", "_promiseSubscribers", "_promiseSubscribersoff", "_promiseEmoteonly", "_promiseEmoteonlyoff", "_promiseWhisper"], [y, [h, l]]);
                                            break;
                                        case "msg_rejected":
                                        case "msg_rejected_mandatory":
                                            this.log.info(x), this.emit("automod", l, h, m);
                                            break;
                                        case "unrecognized_cmd":
                                            this.log.info(x), this.emit("notice", l, h, m);
                                            break;
                                        case "cmds_available":
                                        ...
                                        case "host_off":
                                            break;
                                        default:
                                            m.includes("Login unsuccessful") || m.includes("Login authentication failed") || m.includes("Error logging in") || m.includes("Improperly formatted auth") ? (this.wasCloseCalled = !1, this.reconnect = !1, this.reason = m, this.log.error(this.reason), this.ws.close()) : m.includes("Invalid NICK") ? (this.wasCloseCalled = !1, this.reconnect = !1, this.reason = "Invalid NICK.", this.log.error(this.reason), this.ws.close()) : (this.log.warn("Could not parse NOTICE from tmi.twitch.tv:\n".concat(JSON.stringify(t, null, 4))), this.emit("notice", l, h, m))
                                    }
                                    break;
                                case "USERNOTICE":
                                    ...
                                    switch (f["message-type"] = h) {
                                        case "resub":
                                            ...
                                            break;
                                        case "sub":
                                            this.emit("subscription", l, P, N, m, f);
                                            break;
                                        case "subgift":
                                        ...
                                        case "ritual":
                                            ...
                                            "new_chatter" === R ? this.emit("newchatter", l, P, f, m) : this.emit("ritual", R, l, P, f, m);
                                            break;
                                        default:
                                            this.emit("usernotice", h, l, f, m)
                                    }
                                    break;
                                case "HOSTTARGET":
                                    L = m.split(" "), A = ~~L[1] || 0;
                                    ...
                                    break;
                                case "CLEARCHAT":
                                    1 < t.params.length ? (o = H.get(t.tags["ban-duration"], null), H.isNull(o) ? (this.log.info("[".concat(l, "] ").concat(m, " has been banned.")), this.emit("ban", l, m, null, t.tags)) : (this.log.info("[".concat(l, "] ").concat(m, " has been timed out for ").concat(o, " seconds.")), this.emit("timeout", l, m, null, ~~o, t.tags))) : (this.log.info("[".concat(l, "] Chat was cleared by a moderator.")), this.emits(["clearchat", "_promiseClear"], [
                                        [l],
                                        [null]
                                    ]));
                                    break;
                                case "CLEARMSG":
                                    1 < t.params.length && (o = m, P = f.login, f["message-type"] = "messagedeleted", this.log.info("[".concat(l, "] ").concat(P, "'s message has been deleted.")), this.emit("messagedeleted", l, P, o, f));
                                    break;
                                case "RECONNECT":
                                ...
                                case "GLOBALUSERSTATE":
                                    this.globaluserstate = f, this.emit("globaluserstate", f), void 0 !== t.tags["emote-sets"] && this._updateEmoteset(t.tags["emote-sets"]);
                                    break;
                                case "ROOMSTATE":
                            ...
                            } else if ("jtv" === t.prefix) "MODE" === t.command ? "+o" === m ? (this.moderators[l] || (this.moderators[l] = []), this.moderators[l].includes(t.params[2]) || this.moderators[l].push(t.params[2]), this.emit("mod", l, t.params[2])) : "-o" === m && (this.moderators[l] || (this.moderators[l] = []), this.moderators[l].filter(function(e) {
                                return e != t.params[2]
                                ...
                                case "WHISPER":
                                    M = t.prefix.split("!")[0];
                                    this.log.info("[WHISPER] <".concat(M, ">: ").concat(m)), t.tags.hasOwnProperty("username") || (t.tags.username = M), t.tags["message-type"] = "whisper";
                    ...
                    var h = this;
                    return new Promise(function(e, t) {
                        if (H.isNull(h.ws) || 1 !== h.ws.readyState) return t("Not connected to server.");
                        if (H.isJustinfan(h.getUsername())) return t("Cannot send anonymous messages.");
                        var n, s = H.channel(u);
                        h.userstate[s] || (h.userstate[s] = {}), 500 <= l.length && (n = H.splitLine(l, 500), l = n[0], setTimeout(function() {
                        ...
                        var i = H.merge(h.userstate[s], q.emotes({
                                emotes: q.transformEmotes(o) || null
                            })),
                            r = H.get(h.opts.options.messagesLogLevel, "info"),
                            a = H.actionMessage(l);
                        a ? (i["message-type"] = "action", h.log[r]("[".concat(s, "] *<").concat(h.getUsername(), ">: ").concat(a[1])), h.emits(["action", "message"], [
                            [s, i, a[1], !0]
                        ])) : (i["message-type"] = "chat", h.log[r]("[".concat(s, "] <").concat(h.getUsername(), ">: ").concat(l)), h.emits(["chat", "message"], [
                            [s, i, l, !0]
    ...
    5: [function(e, t, n) {
        ...
        function a(e) {
            ...
            if (c(n)) switch (arguments.length) {
                ...
                for (o = Array.prototype.slice.call(arguments, 1), s = (r = n.slice()).length, i = 0; i < s; i++) r[i].apply(this, o);
            return !0
    ...
    7: [function(e, t, n) {
        ...
        t.exports = {
            ...
            emoteRegex: function(e, t, n, s) {
                r.lastIndex = 0;
                for (var o, i = new RegExp("(\\b|^|s)" + m.unescapeHtml(t) + "(\\b|$|s)"); null !== (o = r.exec(e));) i.test(o[0]) && (s[n] = s[n] || [], s[n].push([o.index, r.lastIndex - 1]))
            },
            emoteString: function(e, t, n, s) {
                var o;
                for (r.lastIndex = 0; null !== (o = r.exec(e));) o[0] === m.unescapeHtml(t) && (s[n] = s[n] || [], s[n].push([o.index, r.lastIndex - 1]))
            },
            ...
            msg: function(e) {
                ...
                for (; n < e.length;) {
                    ...
                    if (-1 === s) {
                        ...
                        for (t.params.push(e.slice(n, s)), n = s + 1; 32 === e.charCodeAt(n);) n++
                }
                return t
            }
        }
                ...
                var o, i = /^\u0001ACTION ([^\u0001]+)\u0001$/,
                    ...
                    m = f.exports = {
                        ...
                        unescapeIRC: function(e) {
                            return e && "string" == typeof e && e.includes("\\") ? e.replace(a, function(e, t) {
                                return t in u ? u[t] : t
                            }) : e
                        },
